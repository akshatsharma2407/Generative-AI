...
prompt2 = PromptTemplate(
    template="Generate 5 short Q/A from following text \n {text}",
    input_variables=["text"]
)

prompt3 = PromptTemplate(
    template="Merge the provided notes and quiz into a single document, first write notes and then mention the quiz \n notes -> {notes} and quiz -> {quiz}",
